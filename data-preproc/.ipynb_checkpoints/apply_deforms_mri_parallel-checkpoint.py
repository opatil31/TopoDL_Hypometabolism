...
# AD_COHORT_FLAT_DIR = '/home/hice1/khom9/scratch/ADNI_Data/cVAE/ad_cohort_mri_flat'
...
AD_COHORT_DEFORM_DIR = '/home/hice1/khom9/scratch/multibrain-mri-y'



def apply_all_deformations_mri_parallel(imgs_dir, deformations_dir, out_dir, num_engines=12):
    '''
    ...
    for eng, img_path, def_path in args:
        out = eng.apply_deformation(img_path, def_path, out_dir, background=True)
